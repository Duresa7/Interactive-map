...
export function TerritoryLegend() {
  ...
  return (
    <div className="absolute bottom-4 left-4 z-20">
      {isExpanded ? (
        <div className="cut-corner bg-[#0a1628]/90 border border-cyan-500/40 backdrop-blur-md p-4 glow-cyan" style={{ maxHeight: '80vh', overflowY: 'auto' }}>
          {/* Header */}
          <div className="flex items-center justify-between mb-3 pb-2 border-b border-cyan-500/30">
            <div className="flex items-center gap-2">
              <Info className="w-4 h-4 text-cyan-400" />
              <h3 className="text-cyan-400 text-xs font-mono uppercase tracking-wider font-bold" style={{ fontFamily: "'Orbitron', monospace" }}>
                OLD REPUBLIC ERA
              </h3>
            </div>
            <button
          ...
          <div className="space-y-3">
            {/* Era Info */}
            <div className="text-cyan-600 text-xs font-mono mb-2">
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-red-400 text-xs font-mono font-bold">SITH EMPIRE</div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-blue-400 text-xs font-mono font-bold">GALACTIC REPUBLIC</div>
                    <div className="text-blue-600 text-xs font-mono opacity-70">Jedi Protected</div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="cut-corner-sm w-8 h-6 border-2 border-orange-500 bg-orange-500/30" style={{ boxShadow: '0 0 8px rgba(249, 115, 22, 0.4)' }} />
                  <div>
                    <div className="text-orange-400 text-xs font-mono font-bold">MANDALORE</div>
                    <div className="text-orange-600 text-xs font-mono opacity-70">Mandalorian Clans</div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="cut-corner-sm w-8 h-6 border-2 border-green-500 bg-green-500/20" style={{ boxShadow: '0 0 8px rgba(132, 204, 22, 0.3)' }} />
                  <div>
                    <div className="text-green-400 text-xs font-mono font-bold">HUTT SPACE</div>
                    <div className="text-green-600 text-xs font-mono opacity-70">Hutt Cartel</div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="cut-corner-sm w-8 h-6 border-2 border-cyan-500 bg-cyan-500/20" style={{ boxShadow: '0 0 8px rgba(0, 255, 255, 0.3)' }} />
                  <div>
                    <div className="text-cyan-400 text-xs font-mono font-bold">NEUTRAL</div>
            ...
            <div className="pt-2 border-t border-cyan-500/20">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-red-400 text-xs font-mono font-bold">SITH FLEET</div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-blue-400 text-xs font-mono font-bold">REPUBLIC FLEET</div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-orange-400 text-xs font-mono font-bold">MANDALORIAN FLEET</div>
            ...
            <div className="pt-2 border-t border-cyan-500/20">
              ...
              <div className="space-y-1 text-cyan-600 text-xs font-mono">
                <div><span className="text-cyan-400">SCROLL</span> - Zoom in/out</div>
                <div><span className="text-cyan-400">DRAG</span> - Pan map</div>
                <div><span className="text-cyan-400">CLICK PLANET</span> - View info</div>
                <div><span className="text-cyan-400">DRAG PLANET</span> - Reposition</div>
              </div>
            </div>
